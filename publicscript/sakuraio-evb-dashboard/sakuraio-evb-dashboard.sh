...
ExecStart=/usr/bin/docker run -d -p %UI_PORT%:8090 -v /log:/log -e MODULE_ID=%MODULE_ID% -e WEBSOCKET_TOKEN=%WEBSOCKET_TOKEN% misodengaku/sakuraio-evb-dashboard
...
# docker run -d -p $UI_PORT:8090 -v /log:/log -e MODULE_ID=$MODULE_ID -e WEBSOCKET_TOKEN=$WEBSOCKET_TOKEN misodengaku/sakuraio-evb-dashboard
